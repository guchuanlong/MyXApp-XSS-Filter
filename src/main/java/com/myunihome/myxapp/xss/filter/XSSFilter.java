package com.myunihome.myxapp.xss.filter;
...
import com.myunihome.myxapp.xss.util.CollectionUtil;
import com.myunihome.myxapp.xss.util.StringUtil;
import com.myunihome.myxapp.xss.wrapper.XssRequestWrapper;
...
public class XSSFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (isIgnorePath(uriPath)) {
        	log.info("ignore xssfilter,path["+uriPath+"] paas through XssFilter, go ahead...");
